...
# Prospecta — Project Context

## What This Is

Prospecta is an AI-powered lead discovery platform for law firms. It scans the web for individuals and businesses showing **legal intent signals** — injury reports, legal inquiries, business disputes, and other case triggers — then filters, qualifies, and enriches each lead so firms know who to contact and why.
...
**Legal Intent Signals** — indicators that someone may need legal representation:
- Personal injury (accidents, slip & fall, medical malpractice, product liability)
...
- Criminal/DUI mentions
- Insurance claim denials
- Landlord/tenant conflicts
- Immigration issues

**Lead Qualification Criteria:**
- **Relevance**: Does this match a practice area the firm handles?
- **Urgency**: Is there a statute of limitations concern or active crisis?
- **Case Value**: What's the potential settlement/case value?
- **Reachability**: Can we find contact info or a way to reach them?

## Workflows

| Workflow | Purpose |
|---|---|
| `workflows/discover_leads.md` | Find new leads across web sources |
| `workflows/enrich_lead.md` | Add context, contact info, and background to a raw lead |
| `workflows/qualify_lead.md` | Score and filter leads by relevance, urgency, and value |
| `workflows/export_leads.md` | Push qualified leads to Google Sheets |

## Tools

| Tool | Purpose |
|---|---|
| `tools/search_web.py` | Search for intent signals via SerpAPI |
| `tools/scrape_single_site.py` | Scrape a specific URL for lead content |
| `tools/enrich_lead.py` | Enrich a lead with contact info via Hunter.io |
| `tools/qualify_lead.py` | Score a lead against qualification criteria |
| `tools/export_to_sheets.py` | Write lead data to Google Sheets |

## Standard Lead Output Format

Every qualified lead should include these fields:
```
...
case_value_estimate   — low | medium | high
